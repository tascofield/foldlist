...
pub trait FoldListSlice<'a,T: 'a, D: Clone + 'a> : 'a + Sized + core::ops::Index<usize,Output=T> {
...
pub trait MutFoldListSlice<'a,T: 'a,D: Clone + 'a>: FoldListSlice<'a,T,D> where Self::UnderlyingChain : MutFoldChainSlice<'a,T,(usize,Self::OriginalD)> {
